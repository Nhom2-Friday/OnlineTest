...
<!--header_top-->
	...
	<div class="main">
			...
			<div class="row">
				...
				<div class="col-md-8 col-lg-12 content">

					<div class="post">
					<div class="panel-default">
						 <div class="panel-heading">
						    <h3 class="panel-title"><h2><a href="">Sự kiện</a></h2></h3>
						 </div>
						<div class="image">
							<img src="tieude1.jpg"
								alt="Image">
					...
					<div class="panel-default">
						  	<div class="panel-heading">
						    	<h3 class="panel-title"><h2><a href="">Hướng dẫn thi</a></h2></h3>
						  	</div>
						  	<div class="image">
								<img src="tieude3.jpg"
								alt="Image">
					...
					<div class="post">
						<div class="panel-default">
							  	<div class="panel-heading">
							    	<h3 class="panel-title"><h2><a href="">Giải đáp</a></h2></h3>
							  	</div>
							 	<div class="image">
									<img src="tieude2.jpg"
									alt="Image">
